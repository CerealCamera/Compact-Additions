 ...
 */
public class InvertedCoggedGearshiftBlock extends CoggedSplitShaftBlock implements IBE<CoggedSplitShaftBlockEntity>, ExtraKinetics.ExtraKineticsBlock {

    public InvertedCoggedGearshiftBlock(Properties properties) {
        super(properties);
    }
