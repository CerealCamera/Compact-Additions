...
public class InvertedCoggedGearshiftVisual extends KineticBlockEntityVisual<InvertedCoggedGearshiftBlockEntity> {

    private final RotatingInstance cogInstance;

    protected final ArrayList<RotatingInstance> keys;

    public InvertedCoggedGearshiftVisual(VisualizationContext context, InvertedCoggedGearshiftBlockEntity blockEntity, float partialTick) {
