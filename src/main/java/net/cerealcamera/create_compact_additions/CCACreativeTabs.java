...
public class CCACreativeTabs {
    public static final DeferredRegister<CreativeModeTab> REGISTER = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CreateCompactAdditions.MODID);

    public static final List<ItemProviderEntry<?, ?>> ITEMS = List.of(
            CCABlocks.INVERTED_ANALOG_TRANSMISSION,
            CCABlocks.COGGED_GEARSHIFT
    );

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN = REGISTER.register("main",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.create_compact_additions.main"))
                    .withTabsBefore(ResourceLocation.parse("simulated:main_tab"))
                    .icon(CCABlocks.INVERTED_ANALOG_TRANSMISSION::asStack)
